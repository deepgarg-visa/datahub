...
public class BusinessAttributeUpdateHookTest {
    ...
    private static final String TEST_BUSINESS_ATTRIBUTE_URN = "urn:li:businessAttribute:12668aea-009b-400e-8408-e661c3a230dd";
    ...
    public void setupTest() throws URISyntaxException {
        ...
        _businessAttributeServiceHook = new BusinessAttributeUpdateService(
                _mockGraphService,
                _mockEntityService,
                ENTITY_REGISTRY
        );
    ...
    public void testMCLOnBusinessAttributeUpdate() throws Exception {
        ...
        final RelatedEntitiesResult mockRelatedEntities =
                new RelatedEntitiesResult(0, 1, 1,
                        ImmutableList.of(new RelatedEntity(IsPartOfRelationship, datasetUrn.toString())));
        // mock response
        Mockito.when(_mockGraphService.findRelatedEntities(
                null, newFilter("urn", TEST_BUSINESS_ATTRIBUTE_URN), null,
        ...
        Mockito.when(_mockEntityService.getEntitiesV2(
        ...
        // mock response
        Mockito.when(_mockEntityService.alwaysProduceMCLAsync(
        ...
        // verify
        Mockito.verify(_mockGraphService, Mockito.times(1)).findRelatedEntities(
    ...
    private void testMCLOnNonBusinessAttributeUpdate() {
        ...
        // verify
        Mockito.verify(_mockGraphService, Mockito.times(0)).findRelatedEntities(
                Mockito.any(), Mockito.any(), Mockito.any(), Mockito.any(), Mockito.any(), Mockito.any(), Mockito.anyInt(), Mockito.anyInt());
    }
    ...
    public static PlatformEvent createPlatformEventBusinessAttribute() throws Exception {
        ...
        PlatformEvent platformEvent =
                createChangeEvent(Constants.BUSINESS_ATTRIBUTE_ENTITY_NAME, Urn.createFromString(TEST_BUSINESS_ATTRIBUTE_URN),
                        ChangeCategory.TAG, ChangeOperation.ADD, newTagUrn.toString(),
                        ImmutableMap.of("tagUrn", newTagUrn.toString()), actorUrn);
    ...
    public static PlatformEvent createBasePlatformEventDataset() {
        ...
        PlatformEvent platformEvent =
                createChangeEvent(Constants.DATASET_ENTITY_NAME, datasetUrn,
                        ChangeCategory.TAG, ChangeOperation.ADD, newTagUrn.toString(),
                        ImmutableMap.of("tagUrn", newTagUrn.toString()), actorUrn);
        return platformEvent;
    }
    ...
    public static PlatformEvent createPlatformEventInvalidCategory() throws Exception {
        ...
        PlatformEvent platformEvent =
                createChangeEvent(Constants.BUSINESS_ATTRIBUTE_ENTITY_NAME, Urn.createFromString(TEST_BUSINESS_ATTRIBUTE_URN),
                        ChangeCategory.DOMAIN, ChangeOperation.ADD, newTagUrn.toString(),
                        ImmutableMap.of("tagUrn", newTagUrn.toString()), actorUrn);
        return platformEvent;
    }

    private static PlatformEvent createChangeEvent(String entityType, Urn entityUrn, ChangeCategory category,
        ...
        changeEvent.setAuditStamp(new AuditStamp().setActor(actor).setTime(BusinessAttributeUpdateHookTest.EVENT_TIME));
    ...
    private Map<Urn, EntityResponse> datasetEntityResponses() {
        ...
        datasetInfoAspects.put(Constants.EDITABLE_SCHEMA_METADATA_ASPECT_NAME, new EnvelopedAspect()
                .setValue(new Aspect(editableSchemaMetadata().data())));
        Map<Urn, EntityResponse> datasetEntityResponses = new HashMap<>();
        datasetEntityResponses.put(datasetUrn, new EntityResponse().setUrn(datasetUrn).setAspects(new EnvelopedAspectMap(datasetInfoAspects)));
    ...
    private EditableSchemaMetadata editableSchemaMetadata() {
        ...
        com.linkedin.schema.EditableSchemaFieldInfo editableSchemaFieldInfo = new EditableSchemaFieldInfo();
